...
/*                }else if(entry.getValue() instanceof Double){
     ...
     * @return
     */
	public static boolean isThisDay(long timestamp1, long timestamp2){
     ...
     * @return
     */
	public static boolean isThisWeek(long timestamp1, long timestamp2){
        if(timestamp1 == 0L || timestamp2 == 0L){
            return false;
        }
        Calendar cal1 = Calendar.getInstance();
     ...
     * @return
     */
	public static boolean isThisMonth(long timestamp1, long timestamp2){
        if(timestamp1 == 0L || timestamp2 == 0L){
            return false;
        }
        Calendar cal1 = Calendar.getInstance();
