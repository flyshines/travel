package qingning.common.server.configuration;
...
@Configuration
@EnableWebMvc
@ComponentScan({"qingning.common.server.controller","qingning.server.advice"})
...
public class SystemConfiguration extends WebMvcConfigurerAdapter {
	...
	public ClassPathXmlApplicationContext getApplicationContext(){
		if(context==null){
			context=new ClassPathXmlApplicationContext(new String[] {"common-rpc-server.xml"});
			context.start();
		}
		return context;
	}
