package qingning.common.server.web;
...
import qingning.common.server.configuration.SystemConfiguration;
		...
		javax.servlet.FilterRegistration.Dynamic filter = context.addFilter("csrfFilter", new Filter (){
			...
			public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterchain)
				...
				if(response instanceof HttpServletResponse){
					...
					httpServletResponse.setHeader("Access-Control-Allow-Headers","x-requested-with,content-type,access_token,app_name,version");
				}
