package qingning.dbcommon.mybatis.pageinterceptor;
...
import qingning.dbcommon.mybatis.pageinterceptor.dialect.Dialect;
import qingning.dbcommon.mybatis.pageinterceptor.domain.PageBounds;
import qingning.dbcommon.mybatis.pageinterceptor.domain.PageList;
import qingning.dbcommon.mybatis.pageinterceptor.domain.Paginator;
import qingning.dbcommon.mybatis.pageinterceptor.support.PropertiesHelper;
import qingning.dbcommon.mybatis.pageinterceptor.support.SQLHelp;
...
public class OffsetLimitInterceptor implements Interceptor {
	...
	public Object intercept(final Invocation invocation) throws Throwable {
		...
		if (pageBounds.isContainsTotalCount()) {
			...
			PageList<Map<String, Object>> list=new PageList(listFuture.get(), countFutrue.get());
		        list.setTotal(countFutrue.get().getTotalCount());
			return list;
		}
