...
import qingning.dbcommon.mybatis.persistence.DeviceActiveInfoMapper;
...
public class DeviceActiveInfoServerImpl extends AbstractMsgService {
	...
	private final static String[] keyFieldNames={
			 "country","province","city","district","plateform","device_model",
			 "device_oem","screen_size","os_version","download_channel", "version","net_status","network_operators"  
	};
	public void setMongoDB(MongoDB mongoDB){
		this.mongoDB = mongoDB;
	}
	
	public void setDeviceActiveInfoMapper(DeviceActiveInfoMapper deviceActiveInfoMapper){
		this.deviceActiveInfoMapper = deviceActiveInfoMapper;
	}
    ...
    public void process(RequestEntity requestEntity, JedisUtils jedisUtils, ApplicationContext context) throws Exception {
		...
		MongoCollection<Document> collection =dataBase.getCollection(String.format(Constants.MONGODB_DEVICE_ACTIVE_COLLECTION_DETAILS_FORMAT, year_month));
